...
type BuildRef struct {
	...
	Subdirectory   string   `json:"subdirectory,omitempty"` // path within the archive, to the build context
	Context        string   `json:"context,omitempty"`      // path within the archive, to the build context
}
